    ...
    <>
      <div className="mb-10 text-center">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {['oasemc', 'aloramc', 'arc8', 'spectrumspark'].map((project, index) => (
            <div key={index} className="group relative overflow-hidden rounded-lg">
              <div className="relative mx-auto h-80 w-80">
                <Image
                  src={`https://s3.justinnn.dev/web/${project}.png`}
                  width={512}
                  height={512}
                  alt={project.charAt(0).toUpperCase() + project.slice(1)}
              ...
              <div className="bg-opacity-60 absolute inset-0 flex w-full flex-col items-center justify-center space-y-4 bg-black opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                {project === 'oasemc' && (
                  <>
                    ...
                    <span className="w-full max-w-60 text-center text-lg text-white">
                      OaseMC, a Dutch Minecraft server with many game modes, but the primary focus is on survival.
                    </span>
                ...
                {project === 'aloramc' && (
                  <>
                    ...
                    <span className="w-full max-w-60 text-center text-lg text-white">
                      AloraMC, an English Minecraft server that focuses on good game modes and currently primarily on CaveBlock.
                    </span>
                ...
                {project === 'arc8' && (
                  <>
                    ...
                    <span className="w-full max-w-60 text-center text-lg text-white">
                      ARC8, a discord bot that has a few games, like counting to 100 (without losing) and dice rolling and a lot more!
                    </span>
                ...
                {project === 'spectrumspark' && (
                  <>
                    <span className="text-xl font-bold text-white">Spectrumspark</span>
                    <span className="w-full max-w-60 text-center text-lg text-white">
                      SpectrumSpark empowers neurodiverse individuals through resources, advocacy, and education, fostering inclusion and celebrating unique strengths.
                    </span>
